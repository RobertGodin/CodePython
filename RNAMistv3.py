...
class RNA(object):
    ...
    def entrainer_par_mini_lot(self,donnees_entrainement,donnees_test,nombre_epochs,taille_mini_lot,eta):
        ...
        for j in range(nombre_epochs):
            ...
            for mini_lot in mini_lots:
                ...
                for x, y in mini_lot:
                    dJ_db_une_ligne, dJ_dw_une_ligne, erreur = self.retropropagation(x, y)
    ...
    def retropropagation(self, x, y):
        ...
        erreur_quadratique = sum((activations[-1]-y)**2)
        ...
        return (dJ_db, dJ_dw, erreur_quadratique)
...
net = RNA([784, 30, 10])
net.entrainer_par_mini_lot(donneesxy_ent,donneesxy_test,30,10,3.0)
