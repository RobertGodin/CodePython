...
def dessiner_bot(f,r):
    ...
    pygame.draw.ellipse(f, VERT, ((r.x,r.y),(r.width, r.height/2))) # Dessiner la tête
    pygame.draw.rect(f, NOIR, ((r.x+r.width/4,r.y+r.height/8),(r.width/10,r.height/20))) # L'oeil gauche
    pygame.draw.rect(f, NOIR, ((r.x+r.width*3/4-r.width/10,r.y+r.height/8),(r.width/10,r.height/20))) # L'oeil droit
    pygame.draw.line(f, NOIR, (r.x+r.width/4,r.y+r.height*3/8),(r.x+r.width*3/4,r.y+r.height*3/8), 2) # La bouche
    pygame.draw.rect(f, ROUGE, ((r.x,r.y+r.height/2),(r.width,r.height/2))) # Le corps
