...
print("Recherche linéaire liste triée")
liste = [ 7,5,10,1,25,8,20 ]
liste.sort()
element = 8
...
print("Recherche binaire liste triée")
liste = [ 7,5,10,1,25,8,20 ]
liste.sort()
element = 8
...
def recherche_binaire_recursive(liste_triee, borne_inferieure, borne_superieure, element):
...
# Function call
result = recherche_binaire_recursive(arr, 0, len(arr)-1, element)
